...
c.setAttribute("id","midibridge-java");a="";a=-1===navigator.userAgent.toLowerCase().indexOf("chrome")?a+'<object tabindex="0" id="midibridge-applet" type="application/x-java-applet" height="1" width="1"><param name="codebase" value="java/" /><param name="archive" value="midiapplet.jar" /><param name="code" value="net.abumarkub.midi.applet.MidiApplet" /><param name="scriptable" value="true" /><param name="minJavaVersion" value="1.5" />Your browser needs the Java plugin to use the midibridge. You can download it <a href="https://web.archive.org/web/20121217103648/http://www.java.com/en/" target="blank" title="abumarkub midibridge download java" rel="abumarkub midibridge download java">here</a></object>':
...
/*
     FILE ARCHIVED ON 10:36:48 Dec 17, 2012 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 68.792
  exclusion.robots: 0.199
  exclusion.robots.policy: 0.176
  cdx.remote: 0.235
  esindex: 0.057
  LoadShardBlock: 41.267 (3)
  PetaboxLoader3.datanode: 84.582 (4)
  load_resource: 108.926
  PetaboxLoader3.resolve: 45.713
*/